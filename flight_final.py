...
def page2():
    ...
    st.subheader('''Here is the heatmap of all the columns based on the correlation with satisfaction column''')
...
#         st.json(selection["selected_rows"])
    ...
    st.subheader('''An interactive plot between columns of the dataset''')
